...
urlpatterns = [
    ...
    path('password_reset/', auth_views.CustomPasswordResetView.as_view(template_name='auth/resetpw/password_reset_form.html', email_template_name='auth/resetpw/password_reset_email.html', subject_template_name='auth/resetpw/password_reset_subject.txt'), name='password_reset'),

    path('password_reset/done/', django_auth_views.PasswordResetDoneView.as_view(template_name='auth/resetpw/password_reset_done.html'), name='password_reset_done'),

    path('reset/<str:uidb64>/<str:token>/', auth_views.password_reset_confirm, name='password_reset_confirm'),

    path('reset/done/', django_auth_views.PasswordResetCompleteView.as_view(template_name='auth/resetpw/password_reset_complete.html'), name='password_reset_complete'),
